...
export default function BlogCard({
  ...
  return (
    <div
      className={` ${
        big && "col-span-2"
      } cust-bord relative overflow-hidden group/blog cust-anim-1 group p-4 rounded-md`}
    >
      <h3 className="text-lg text-[var(--foreground)] cust-anim-1 font-semibold mb-2">
        {head}
      </h3>
      ...
      <div className="absolute -translate-x-[100%] group-hover/blog:translate-0 cust-anim-2 top-0 left-0 h-full w-full flex">
        <button className="h-full w-full font-semibold bg-[var(--dark)] cursor-pointer text-[var(--foreground)]/70">
          Read Article
        </button>
      </div>
    </div>
